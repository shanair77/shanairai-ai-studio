...
/** Aged brass used for the end-card rule; a softer parchment tone for the tint. */
const GOLD = "#c9a962";
const PARCHMENT = "#d8ccae";

/**
 * Grade — a parchment tint (softer than LuxuryReel's gold: this is daylight footage) plus darkened top/bottom bands (which also keep text clear of the
  ...
  <>
    ...
    <AbsoluteFill
      style={{
        pointerEvents: "none",
        background:
          "linear-gradient(180deg, rgba(0,0,0,0.42) 0%, rgba(0,0,0,0) 22%, rgba(0,0,0,0) 70%, rgba(0,0,0,0.55) 100%)",
      }}
    />
    <AbsoluteFill
      style={{
        pointerEvents: "none",
        background: "radial-gradient(ellipse at 50% 46%, rgba(0,0,0,0) 44%, rgba(0,0,0,0.5) 100%)",
      }}
    />
  </>
);
