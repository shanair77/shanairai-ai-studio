/**
 * LuxuryReel — a 30-second, 1080×1920 Instagram Reel in the "High class." montage style.
 *
 ...
 * by `calculateLuxuryReelMetadata`, so lengthening the edit lengthens the composition.
 */
...
export const calculateLuxuryReelMetadata: CalculateMetadataFunction<LuxuryReelProps> = ({ props }) => ({
  durationInFrames: totalFrames(props.cuts, FPS),
});

export const LuxuryReel: React.FC<LuxuryReelProps> = ({
  caption,
  handle,
  tagline,
  music,
