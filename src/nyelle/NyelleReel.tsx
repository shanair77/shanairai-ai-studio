/**
 * NyelleReel — a 30-second, 1080×1920 Instagram Reel in the LuxuryReel montage format, with Nyelle (a trained Higgsfield Soul) as the through-line across the night-city footage.
 *
 ...
 * by `calculateNyelleReelMetadata`, so lengthening the edit lengthens the composition.
 */
...
export const defaultNyelleReelProps: NyelleReelProps = {
  caption: "Unveiled.",
  handle: "@shanair.ai",
...
export const calculateNyelleReelMetadata: CalculateMetadataFunction<NyelleReelProps> = ({ props }) => ({
  durationInFrames: totalFrames(props.cuts, FPS),
});

export const NyelleReel: React.FC<NyelleReelProps> = ({
  caption,
  handle,
  tagline,
  music,
